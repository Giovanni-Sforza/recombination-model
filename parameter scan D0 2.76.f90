...
! scan the parameter space
	...
	INTEGER IPOINT, IPAR1, IPAR2, CCi,CTi,TCi,Ti,times
	REAL(8) CHISQ
...
! D^0
	...
	open(unit = 11, file = "err of dNptdpt_"//CollSys//"_D0_c40.txt", status = "unknown")
...
! T and T_s for 2.76 and 5.02 TeV are from Eqs. (4)-(7) of HZ2018, PRC97, 054902(2018)
	T = 0.1D0 + Ti * 0.01D0   !for i=0--10       !0.39D0
	cT= 22.5D0 + CTi * 0.2D0   !for i=0--10       !23.2D0    ! c=0.025

	Ts = 0.51D0
	cS = 11.0D0    ! c=0.025

    !Tc & Cc
    Tc = 0.64D0 + TCi * 0.02D0   !for i=0--10      !0.68d0          !0.73d0!0.7
    cc = 0.75d0 + CCi * 0.02D0   !for i=0--10      !0.8D0   !2.5d0!2.7
